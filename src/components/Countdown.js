    ...
    return (
      <div className="Countdown">
        ...
        <div className="Countdown-display">
          ...
          <div className="countdown-arrow">
          <button onClick={() => this.adjustTimer("decHours")} style={{backgroundcolor:"red"}}>&#8681;</button>
        ...
        {timerOn === false &&  
          (timerStart !== 0 && !timerOn && timerStart !== timerTime && timerTime !== 0) && (
            <button className="Button-start" onClick={this.startTimer}>
              Resume
            </button>
          )}
        ...
        {(timerOn === false || timerTime < 1000) &&
          (timerStart !== timerTime && timerStart > 0) && (timerTime!=0 && !timerOn) ?
